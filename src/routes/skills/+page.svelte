...
<main class="container py-10 flex flex-col items-center justify-center text-center min-h-[800px]">
  ...
  <p class="leading-7 font-bold text-xl [&:not(:first-child)]:mt-6">
    ...
    <a href="https://redis.io/" target="_blank" class="hover:underline">redis 68%,</a> <br />
    <a href="https://www.sqlite.org/index.html" target="_blank" class="hover:underline">sqlite 80%,</a> <br />
    <a href="https://www.python.org/" target="_blank" class="hover:underline">python 30%,</a> <br />
